...
<div className="min-h-screen flex flex-col text-white">
			<main className="container mx-auto px-6 pt-16 flex-1 text-center">
				...
				<h1 className="text-3xl md:text-6xl lg:text-8xl uppercase font-black mb-8">The resting club</h1>

				<p className="text-base md:text-lg lg:text-2xl mb-8">A place where people who are stressed come and stay to relax their mind!</p>
			...
			<footer className="container mx-auto p-6">
				<div className="flex flex-col md:flex-row items-center justify-between">
					<p className="mb-4 md:mb-0 md:text-xl">Built with 💖 by Okpe Onoja</p>
